...
# from django.contrib import messages
# from django.shortcuts import render, redirect, get_object_or_404
# from .forms import RegistrationForm, ProductForm, WishlistForm, CustomPasswordChangeForm, UserProfileForm, CategoryForm
# from .models import User, Product, Wishlist, Category, Cart, CartItem
...
#         if form.is_valid():
#             form.save()
#             return redirect('product_list')  # Assuming 'product_list' is the URL name for the product list page
#     else:
#         form = ProductForm()
#     return render(request, 'add_product.html', {'form': form})
...
#             # For example, you can use session variables or a database model to store cart items
#             # For simplicity, let's assume we're using session variables
